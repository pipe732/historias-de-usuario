...
urlpatterns = [
    ...
    path(
        "tipos-mantenimiento/<int:pk>/editar/",
    ...
    # MANTENIMIENTO
    # /mantenimiento/
    path("", views.MantenimientoListView.as_view(), name="mantenimiento_lista"),
