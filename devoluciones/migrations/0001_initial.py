...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('codigo_devolucion', models.AutoField(db_column='codigo_devolucion', primary_key=True, serialize=False)),
                ...
                ('codigo_prestamo', models.ForeignKey(db_column='codigo_prestamo', on_delete=django.db.models.deletion.PROTECT, related_name='devoluciones', to='prestamo.prestamo', verbose_name='Préstamo')),
                ('codigo_recibe', models.ForeignKey(blank=True, db_column='codigo_recibe', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='devoluciones_recibidas', to='usuario.usuario', verbose_name='Usuario que recibe')),
                ('items', models.ManyToManyField(blank=True, related_name='devoluciones', to='prestamo.detalleprestamo', verbose_name='Ítems devueltos')),
            ],
            options={
