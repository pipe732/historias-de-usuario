    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "id_estante",
                    models.CharField(max_length=100, verbose_name="Estante"),
                ),
                (
                    "cantidad",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nit_proveedor",
                    models.CharField(max_length=50, unique=True, verbose_name="NIT"),
                ),
                (
                    "telefono_contacto",
                    models.CharField(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, verbose_name="Stock / Cantidad"
                    ),
                ),
                (
                    "numero_serie",
                ...
                (
                    "disponible",
                    models.BooleanField(
                        default=True, verbose_name="Disponible para préstamo"
                    ),
                ),
                (
                    "ubicacion",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stock_anterior",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Stock anterior"
                    ),
                ),
                (
                    "stock_nuevo",
                    models.PositiveIntegerField(default=0, verbose_name="Stock nuevo"),
                ),
                (
                    "usuario_nombre",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "estado",
                    models.CharField(
                        choices=[("V", "Vigente"), ("D", "Descontinuado")],
                        max_length=20,
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="producto",
            index=models.Index(
                fields=["codigo_sku"], name="inventario__codigo__32a2e9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="producto",
        ...
        migrations.AddIndex(
            model_name="inventario",
            index=models.Index(
                fields=["id_estante"], name="inventario__id_esta_54b5f0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="movimientos",
            index=models.Index(
                fields=["fecha_movimiento"], name="inventario__fecha_m_0e3855_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="movimientos",
            index=models.Index(
                fields=["tipo_de_movimiento"], name="inventario__tipo_de_305682_idx"
            ),
        ),
    ]
